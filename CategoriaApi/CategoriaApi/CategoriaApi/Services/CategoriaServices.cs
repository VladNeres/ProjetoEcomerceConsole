...
namespace CategoriaApi.Services
{
    public class CategoriaServices
    {
        ...
        {
            Categoria categoriaNome = _repository.RecuperarCategoriaNome(categoriaDto);
        ...
        {
            Categoria categorias = _repository.RecuperarCategoriaPorId(id);
            IEnumerable<SubCategoria> subCategorias = _repository.RecuperarSubCategoriaPorId(id);
        ...
        {
            Categoria categoria = _repository.RecuperarCategoriaPorId(id);
            if (categoria == null)
            {
        ...
        {
            List<Categoria> categorias = _repository.RecuperarListaDeCategoria();
            if (categorias == null)
            {
                return null;
            }
